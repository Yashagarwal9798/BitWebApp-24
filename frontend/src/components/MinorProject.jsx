...
const MinorProject = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      const sortedProfessors = allProfsResponse.data.message
        ...
        .sort((a, b) => {
          const seatsA =
            a.limits.minor_project - a.currentCount.minor_project;
          const seatsB =
            b.limits.minor_project - b.currentCount.minor_project;
          return seatsB - seatsA;
        });

      setAppliedProfessors(minorAppliedProfs);
      setDenied(denied || []);
      if (isMinorAllocated && prof) setAllocatedProf(prof);
  ...
  const handleViewDetails = async () => {
    if (allocatedProf) {
      try {
        setLoading(true);
        const response = await axios.post("/api/v1/minor/get-disc-student");
  ...
  const handleSubmit = async () => {
    ...
    try {
      setLoading(true);
      await axios.post("/api/v1/minor/apply-faculty", {
            ...
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
              <div className="bg-gradient-to-r from-green-500 to-emerald-600 p-6 text-white">
                <h1 className="text-2xl md:text-3xl font-bold">
                  Minor Project Allocation
                </h1>
                <p className="text-green-100 mt-1">
                  Your minor project details
                </p>
              </div>
              <div className="p-8">
                <div className="text-center">
                  ...
                  <p className="text-xl mb-6 text-gray-700">
                    Your minor project has been successfully allocated under
                  </p>
            ...
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
              ...
              <div className="bg-gradient-to-r from-blue-600 to-indigo-700 p-6 text-white">
                ...
                <p className="text-blue-100 mt-1">
                  Select a professor for your minor project
                </p>
              </div>
